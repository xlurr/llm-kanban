...
import { Search, Play, Trash2, Pencil, CalendarClock } from 'lucide-react'
      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <div className="flex gap-1 flex-wrap">
          ...
          {columns.map((col) => (
            <Button
              key={col.id}
              variant={filterStatus === col.id ? 'default' : 'outline'}
              size="sm"
                ...
                <CardContent className="p-4 flex-1">
                  <div className="flex items-center justify-between gap-4">
                    ...
                    <div className="flex items-center gap-2 shrink-0">
                      ...
                      {task.review && (
                        <Badge variant="secondary">{task.review.score}/10</Badge>
                      )}
                      <Button
                        size="icon"
                        variant="ghost"
